...
void _polynomial_xgcd(const std::vector<FieldT> &a, const std::vector<FieldT> &b, std::vector<FieldT> &g, std::vector<FieldT> &u, std::vector<FieldT> &v)
{
    ...
    std::transform(G.begin(), G.end(), G.begin(), [lead_coeff](FieldT f) {return f * lead_coeff; });
    std::transform(U.begin(), U.end(), U.begin(), [lead_coeff](FieldT f) {return f * lead_coeff; });
    std::transform(V1.begin(), V1.end(), V1.begin(), [lead_coeff](FieldT f) {return f * lead_coeff; });
